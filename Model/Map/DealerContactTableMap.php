...
class DealerContactTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'DealerId', 'IsDefault', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_STUDLYPHPNAME => array('id', 'dealerId', 'isDefault', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(DealerContactTableMap::ID, DealerContactTableMap::DEALER_ID, DealerContactTableMap::IS_DEFAULT, DealerContactTableMap::CREATED_AT, DealerContactTableMap::UPDATED_AT, ),
        self::TYPE_RAW_COLNAME   => array('ID', 'DEALER_ID', 'IS_DEFAULT', 'CREATED_AT', 'UPDATED_AT', ),
        self::TYPE_FIELDNAME     => array('id', 'dealer_id', 'is_default', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'DealerId' => 1, 'IsDefault' => 2, 'CreatedAt' => 3, 'UpdatedAt' => 4, ),
        self::TYPE_STUDLYPHPNAME => array('id' => 0, 'dealerId' => 1, 'isDefault' => 2, 'createdAt' => 3, 'updatedAt' => 4, ),
        self::TYPE_COLNAME       => array(DealerContactTableMap::ID => 0, DealerContactTableMap::DEALER_ID => 1, DealerContactTableMap::IS_DEFAULT => 2, DealerContactTableMap::CREATED_AT => 3, DealerContactTableMap::UPDATED_AT => 4, ),
        self::TYPE_RAW_COLNAME   => array('ID' => 0, 'DEALER_ID' => 1, 'IS_DEFAULT' => 2, 'CREATED_AT' => 3, 'UPDATED_AT' => 4, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'dealer_id' => 1, 'is_default' => 2, 'created_at' => 3, 'updated_at' => 4, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, )
    );
