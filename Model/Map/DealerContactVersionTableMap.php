...
use Dealer\Model\DealerContactVersion;
use Dealer\Model\DealerContactVersionQuery;
...
/**
 * This class defines the structure of the 'dealer_contact_version' table.
 *
 *
 *
 ...
 *
 */
class DealerContactVersionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Dealer.Model.Map.DealerContactVersionTableMap';
     ...
     */
    const TABLE_NAME = 'dealer_contact_version';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Dealer\\Model\\DealerContactVersion';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Dealer.Model.DealerContactVersion';
     ...
     */
    const ID = 'dealer_contact_version.ID';
     ...
     */
    const CREATED_AT = 'dealer_contact_version.CREATED_AT';

    /**
     * the column name for the UPDATED_AT field
     */
    const UPDATED_AT = 'dealer_contact_version.UPDATED_AT';

    /**
     * the column name for the VERSION field
     */
    const VERSION = 'dealer_contact_version.VERSION';

    /**
     * the column name for the VERSION_CREATED_AT field
     */
    const VERSION_CREATED_AT = 'dealer_contact_version.VERSION_CREATED_AT';

    /**
     * the column name for the VERSION_CREATED_BY field
     */
    const VERSION_CREATED_BY = 'dealer_contact_version.VERSION_CREATED_BY';
    ...
    {
        // attributes
        $this->setName('dealer_contact_version');
        $this->setPhpName('DealerContactVersion');
        $this->setClassName('\\Dealer\\Model\\DealerContactVersion');
     ...
     * and findPk*() calls.
     *
     * @param \Dealer\Model\DealerContactVersion $obj A \Dealer\Model\DealerContactVersion object.
     ...
     *
     * @param mixed $value A \Dealer\Model\DealerContactVersion object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Dealer\Model\DealerContactVersion) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Dealer\Model\DealerContactVersion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? DealerContactVersionTableMap::CLASS_DEFAULT : DealerContactVersionTableMap::OM_CLASS;
    }
     ...
     * @return array (DealerContactVersion object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = DealerContactVersionTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = DealerContactVersionTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + DealerContactVersionTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = DealerContactVersionTableMap::OM_CLASS;
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            DealerContactVersionTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = DealerContactVersionTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = DealerContactVersionTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(DealerContactVersionTableMap::DATABASE_NAME)->getTable(DealerContactVersionTableMap::TABLE_NAME);
    }
    ...
    {
      $dbMap = Propel::getServiceContainer()->getDatabaseMap(DealerContactVersionTableMap::DATABASE_NAME);
      if (!$dbMap->hasTable(DealerContactVersionTableMap::TABLE_NAME)) {
        $dbMap->addTableObject(new DealerContactVersionTableMap());
      }
    }

    /**
     * Performs a DELETE on the database, given a DealerContactVersion or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or DealerContactVersion object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Dealer\Model\DealerContactVersion) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(DealerContactVersionTableMap::ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(DealerContactVersionTableMap::VERSION, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = DealerContactVersionQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) { DealerContactVersionTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) { DealerContactVersionTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return DealerContactVersionQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a DealerContactVersion or Criteria object.
     *
     * @param mixed               $criteria Criteria or DealerContactVersion object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from DealerContactVersion object
        }
...
//
DealerContactVersionTableMap::buildTableMap();
