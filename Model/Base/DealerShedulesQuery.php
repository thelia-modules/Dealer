 ...
 * @method     ChildDealerShedulesQuery orderByVersion($order = Criteria::ASC) Order by the version column
 * @method     ChildDealerShedulesQuery orderByVersionCreatedAt($order = Criteria::ASC) Order by the version_created_at column
 * @method     ChildDealerShedulesQuery orderByVersionCreatedBy($order = Criteria::ASC) Order by the version_created_by column
 *
 ...
 * @method     ChildDealerShedulesQuery groupByVersion() Group by the version column
 * @method     ChildDealerShedulesQuery groupByVersionCreatedAt() Group by the version_created_at column
 * @method     ChildDealerShedulesQuery groupByVersionCreatedBy() Group by the version_created_by column
 *
 ...
 *
 * @method     ChildDealerShedulesQuery leftJoinDealerShedulesVersion($relationAlias = null) Adds a LEFT JOIN clause to the query using the DealerShedulesVersion relation
 * @method     ChildDealerShedulesQuery rightJoinDealerShedulesVersion($relationAlias = null) Adds a RIGHT JOIN clause to the query using the DealerShedulesVersion relation
 * @method     ChildDealerShedulesQuery innerJoinDealerShedulesVersion($relationAlias = null) Adds a INNER JOIN clause to the query using the DealerShedulesVersion relation
 *
 ...
 * @method     ChildDealerShedules findOneByVersion(int $version) Return the first ChildDealerShedules filtered by the version column
 * @method     ChildDealerShedules findOneByVersionCreatedAt(string $version_created_at) Return the first ChildDealerShedules filtered by the version_created_at column
 * @method     ChildDealerShedules findOneByVersionCreatedBy(string $version_created_by) Return the first ChildDealerShedules filtered by the version_created_by column
 *
 ...
 * @method     array findByVersion(int $version) Return ChildDealerShedules objects filtered by the version column
 * @method     array findByVersionCreatedAt(string $version_created_at) Return ChildDealerShedules objects filtered by the version_created_at column
 * @method     array findByVersionCreatedBy(string $version_created_by) Return ChildDealerShedules objects filtered by the version_created_by column
 *
 */
abstract class DealerShedulesQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT ID, DEALER_ID, DAY, BEGIN, END, CLOSED, PERIOD_BEGIN, PERIOD_END, CREATED_AT, UPDATED_AT, VERSION, VERSION_CREATED_AT, VERSION_CREATED_BY FROM dealer_shedules WHERE ID = :p0';
        try {
    ...
    public function filterByVersion($version = null, $comparison = null)
    {
        if (is_array($version)) {
            ...
            if (isset($version['min'])) {
                $this->addUsingAlias(DealerShedulesTableMap::VERSION, $version['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($version['max'])) {
                $this->addUsingAlias(DealerShedulesTableMap::VERSION, $version['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DealerShedulesTableMap::VERSION, $version, $comparison);
    }
    ...
    public function filterByVersionCreatedAt($versionCreatedAt = null, $comparison = null)
    {
        if (is_array($versionCreatedAt)) {
            ...
            if (isset($versionCreatedAt['min'])) {
                $this->addUsingAlias(DealerShedulesTableMap::VERSION_CREATED_AT, $versionCreatedAt['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($versionCreatedAt['max'])) {
                $this->addUsingAlias(DealerShedulesTableMap::VERSION_CREATED_AT, $versionCreatedAt['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(DealerShedulesTableMap::VERSION_CREATED_AT, $versionCreatedAt, $comparison);
    }
    ...
    public function filterByVersionCreatedBy($versionCreatedBy = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(DealerShedulesTableMap::VERSION_CREATED_BY, $versionCreatedBy, $comparison);
    }
    ...
    /**
     * Filter the query by a related \Dealer\Model\DealerShedulesVersion object
     *
     * @param \Dealer\Model\DealerShedulesVersion|ObjectCollection $dealerShedulesVersion  the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildDealerShedulesQuery The current query, for fluid interface
     */
    public function filterByDealerShedulesVersion($dealerShedulesVersion, $comparison = null)
    {
        if ($dealerShedulesVersion instanceof \Dealer\Model\DealerShedulesVersion) {
            return $this
                ->addUsingAlias(DealerShedulesTableMap::ID, $dealerShedulesVersion->getId(), $comparison);
        } elseif ($dealerShedulesVersion instanceof ObjectCollection) {
            return $this
                ->useDealerShedulesVersionQuery()
                ->filterByPrimaryKeys($dealerShedulesVersion->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByDealerShedulesVersion() only accepts arguments of type \Dealer\Model\DealerShedulesVersion or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the DealerShedulesVersion relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return ChildDealerShedulesQuery The current query, for fluid interface
     */
    public function joinDealerShedulesVersion($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('DealerShedulesVersion');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'DealerShedulesVersion');
        }
    ...
    /**
     * Use the DealerShedulesVersion relation DealerShedulesVersion object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return   \Dealer\Model\DealerShedulesVersionQuery A secondary query class using the current class as primary query
     */
    public function useDealerShedulesVersionQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinDealerShedulesVersion($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'DealerShedulesVersion', '\Dealer\Model\DealerShedulesVersionQuery');
    }
