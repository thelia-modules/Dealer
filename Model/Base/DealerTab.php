...
abstract class DealerTab implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Dealer\\Model\\Map\\DealerTabTableMap';
    ...
    /**
     * Initializes internal state of Dealer\Model\Base\DealerTab object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>DealerTab</code> instance.  If
     * <code>obj</code> is an instance of <code>DealerTab</code>, delegates to
     * <code>equals(DealerTab)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return DealerTab The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[DealerTabTableMap::ID] = true;
        }
    ...
    public function setCompany($v)
    {
        ...
        if ($this->company !== $v) {
            $this->company = $v;
            $this->modifiedColumns[DealerTabTableMap::COMPANY] = true;
        }
    ...
    public function setAddress1($v)
    {
        ...
        if ($this->address1 !== $v) {
            $this->address1 = $v;
            $this->modifiedColumns[DealerTabTableMap::ADDRESS1] = true;
        }
    ...
    public function setAddress2($v)
    {
        ...
        if ($this->address2 !== $v) {
            $this->address2 = $v;
            $this->modifiedColumns[DealerTabTableMap::ADDRESS2] = true;
        }
    ...
    public function setZipcode($v)
    {
        ...
        if ($this->zipcode !== $v) {
            $this->zipcode = $v;
            $this->modifiedColumns[DealerTabTableMap::ZIPCODE] = true;
        }
    ...
    public function setCity($v)
    {
        ...
        if ($this->city !== $v) {
            $this->city = $v;
            $this->modifiedColumns[DealerTabTableMap::CITY] = true;
        }
    ...
    public function setDescription($v)
    {
        ...
        if ($this->description !== $v) {
            $this->description = $v;
            $this->modifiedColumns[DealerTabTableMap::DESCRIPTION] = true;
        }
    ...
    public function setSchedule($v)
    {
        ...
        if ($this->schedule !== $v) {
            $this->schedule = $v;
            $this->modifiedColumns[DealerTabTableMap::SCHEDULE] = true;
        }
    ...
    public function setPhoneNumber($v)
    {
        ...
        if ($this->phone_number !== $v) {
            $this->phone_number = $v;
            $this->modifiedColumns[DealerTabTableMap::PHONE_NUMBER] = true;
        }
    ...
    public function setWebSite($v)
    {
        ...
        if ($this->web_site !== $v) {
            $this->web_site = $v;
            $this->modifiedColumns[DealerTabTableMap::WEB_SITE] = true;
        }
    ...
    public function setLatitude($v)
    {
        ...
        if ($this->latitude !== $v) {
            $this->latitude = $v;
            $this->modifiedColumns[DealerTabTableMap::LATITUDE] = true;
        }
    ...
    public function setLongitude($v)
    {
        ...
        if ($this->longitude !== $v) {
            $this->longitude = $v;
            $this->modifiedColumns[DealerTabTableMap::LONGITUDE] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($dt !== $this->created_at) {
                $this->created_at = $dt;
                $this->modifiedColumns[DealerTabTableMap::CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($dt !== $this->updated_at) {
                $this->updated_at = $dt;
                $this->modifiedColumns[DealerTabTableMap::UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : DealerTabTableMap::translateFieldName('Company', TableMap::TYPE_PHPNAME, $indexType)];
            $this->company = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : DealerTabTableMap::translateFieldName('Address1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : DealerTabTableMap::translateFieldName('Address2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->address2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : DealerTabTableMap::translateFieldName('Zipcode', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildDealerTabQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see DealerTab::setDeleted()
     * @see DealerTab::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildDealerTabQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($isInsert) {
                ...
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(DealerTabTableMap::UPDATED_AT)) {
                    $this->setUpdatedAt(time());
                }
            }
            if ($ret) {
                ...
                $this->postSave($con);
                DealerTabTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO dealer_tab (%s) VALUES (%s)',
    ...
    {
        $pos = DealerTabTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['DealerTab'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['DealerTab'][$this->getPrimaryKey()] = true;
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Dealer\Model\DealerTab (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \Dealer\Model\DealerTab Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(DealerTabTableMap::DEFAULT_STRING_FORMAT);
    }
     ...
     *
     * @return     ChildDealerTab The current object (for fluent API support)
     */
