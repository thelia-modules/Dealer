...
class BrandLinkController extends BaseController
{
    ...
    {
        if (!$this->service) {
            $this->service = $this->getContainer()->get("dealer_brand_link_service");
        }
    ...
    public function deleteAction(TokenProvider $tokenProvider, RequestStack $requestStack, ParserContext $parserContext)
    {
        ...
        try {
            ...
            $data = [
                "brand_id" => $requestStack->getCurrentRequest()->request->get(static::CONTROLLER_ENTITY_NAME . "_id"),
