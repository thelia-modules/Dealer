...
class AdminLinkController extends BaseController
{
    ...
    const CONTROLLER_CHECK_RESOURCE = Dealer::RESOURCES_USERS;
    /**
     * @inheritDoc
     */
    ...
    /**
     * Method to get current controller users service
     * @return object
     */
    protected function getService()
    {
        if (!$this->service) {
            $this->service = $this->getContainer()->get("dealer_admin_link_service");
        }
    ...
    public function deleteAction(TokenProvider $tokenProvider, RequestStack $requestStack, ParserContext $parserContext)
    {
        ...
        try {
            ...
            $data = [
                "admin_id" => $requestStack->getCurrentRequest()->request->get(static::CONTROLLER_ENTITY_NAME . "_id"),
